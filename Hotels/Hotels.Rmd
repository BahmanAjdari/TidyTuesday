...
# Cancelation behaviour among top travelers
```{r}
hotel_cancelation<- hotels_iso3c%>%
  ...
  labs(
    ...
    subtitle = "Percentages of cancelation vs. successful check-ins among top travelers",
    fill= "",
    x="Country of Origin",
    y=""
  )
hotel_cancelation
# second attempt
# countries with at least 1000 observation and have high rate of total cancelation
# both hotel types
 hotel_type<- hotels_iso3c %>%
    ...
    coord_flip()+
    labs(
      title= "Countries with most total proportional cancelation",
      subtitle = "Proportion of Cancelation for City Hotels and Resort Hotels among\n countries with at least 500 bookings",
      fill="",
      x="Country of Origin",
      y=""
    )
...
```{r}
  ...
  coord_flip()+
    labs(
      ...
      subtitle = "Proportion of top travelers who travel with/without children",
      x="Country of Origin",
      y="",
      fill=""
    )
...
book_hotels<- hotels_iso3c %>%
  ...
  theme+
  labs(
    title = "How soon travelers book their hotels?",
...
```{r}
plot_grid(plot_grid(hotel_cancelation, hotel_type, ncol = 2, nrow = 1), booking_trend, plot_grid(box_plot, book_hotels), nrow = 3,rel_heights = c(1.25,1,1.25))
...
text_intro
patchwork <- (hotel_cancelation+hotel_type)/booking_trend / (box_plot+book_hotels)
patchwork
```
