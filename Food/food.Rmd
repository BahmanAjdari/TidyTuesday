...
border_food %>%
  ...
  labs(
    title = "Relationship Between the Ratio of Coastline to \nLand Area (m/km^2)and Fish Consumption",
    #subtitle = "It seems there is no relationship between the ratio of coastline to Land Area and Fish consumption.",
    x= "Coastline(m) to Land Area(km^2)",
    y="Total Consumption (kg/person/year)",
   caption = "Data:nu3.de | Visualization:@BahmanAjdari "
  )
```
